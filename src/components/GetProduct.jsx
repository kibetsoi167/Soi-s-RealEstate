  ...
  {/* NAVBAR */}
      ...
      <div className="offer-words d-flex justify-content-center align-items-center">
        <div className="fade-text-wrapper">
          <span className="fade-text"> Best Deals on lands </span>
          ...
          <div className="carousel-inner">
            ...
            >
              ...
              <div className="carousel-caption colourful-caption">
                ...
                <h1>Welcome to soi's realestate agency</h1>
                <p>A place to get affordable and cheap offer on lands.</p>
                <p className="features"> a trusted agency</p>
                <button 
            ...
            >
              ...
              <div className="carousel-caption colourful-caption">
                <h1>Want to Sell Your land</h1>
                <p>Add your land quickly and reach thousands of buyers.</p>
            ...
            >
              ...
              <div className="carousel-caption colourful-caption">
                ...
                <p>Pay quickly and safely for the land you need.</p>
